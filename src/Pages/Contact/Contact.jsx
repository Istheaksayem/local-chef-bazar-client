  ...
  return (
    <div className="font-sans text-gray-800 dark:text-gray-200 dark:bg-gray-900">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://your-image-link.com/banner.jpg')",
      ...
      >
        <div className="text-center text-white">
          ...
          <Link to="/" className="mt-2 text-sm block">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg
            ...
            className="relative block w-full h-16 fill-white dark:fill-gray-900"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          {/* Office */}
          <div className="p-8 rounded-lg shadow-sm transition
                          bg-white dark:bg-gray-800
                          border border-gray-100 dark:border-gray-700">
            <div className="text-teal-500 text-3xl mb-4 flex justify-center">
              📍
            </div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">
              445 Mount Eden Road, Mt Eden Basundhara Chokrapath
            </p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="p-8 rounded-lg shadow-sm
          ...
          <form className="space-y-4">
            {["First Name", "Last Name", "Email", "Phone"].map((item) => (
              <input
                key={item}
                type="text"
                placeholder={item}
